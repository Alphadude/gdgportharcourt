...
const SOCIALS = [
  ...
  {
    name: "TikTok",
    href: "https://www.tiktok.com/@gdgportharcourt",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.04.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93v7.2c0 1.63-.39 3.29-1.28 4.7-1.12 1.77-2.92 3.01-4.96 3.41-2.02.4-4.13.11-5.91-.9-1.79-1-3.15-2.67-3.72-4.63-.58-1.95-.31-4.08.76-5.83 1.07-1.74 2.8-2.95 4.78-3.4 1.25-.28 2.54-.26 3.79.03V12.7c-.55-.17-1.13-.26-1.7-.24-1.29.04-2.55.51-3.52 1.34-.97.83-1.6 2.03-1.75 3.32-.15 1.29.17 2.6 .88 3.66.72 1.05 1.83 1.76 3.06 1.95 1.24.2 2.53-.08 3.57-.77 1.04-.69 1.75-1.75 1.96-3v-19z" />
      </svg>
    ),
  },
];
