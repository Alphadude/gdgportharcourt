...
const MEMORY_IMAGES = [
  {
    src: "/devfest-2025/community.jpg",
  ...
  {
    src: "/devfest-2025/highlights.jpg",
  ...
  {
    src: "/devfest-2025/femalespeakers.jpg",
    alt: "DevFest Women in Tech",
    title: "Women in Tech",
    caption: "A celebration of women leading and innovating in tech",
    tag: "Women in Tech",
  },
  {
    src: "/devfest-2025/girls.jpg",
    alt: "DevFest Girls in Tech",
    title: "Girls in STEM",
    caption: "Inspiring the next generation of women developers and engineers",
    tag: "Girls in Tech",
  },
];
